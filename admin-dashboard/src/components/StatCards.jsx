...
const StatCards = ({ startDate = null, endDate = null }) => {
  ...
  useEffect(() => {
    ...
    const fetchStats = async () => {
      try {
        ...
        console.log('StatCards - Fetching stats with dates:', { startDate, endDate });

        const response = await statecardsService.getStats(startDate, endDate);
